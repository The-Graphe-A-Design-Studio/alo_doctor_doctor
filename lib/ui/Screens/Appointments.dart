...
class _AppointmentsState extends State<Appointments> {
  ...
  void initState() {
    ...
    appointList.add(Modal(name: 'Akash Bose', time: '4:30', isSelected: false));
    appointList
        .add(Modal(name: 'Priya shetty', time: '5:30', isSelected: false));
    appointList.add(Modal(name: 'Pooja Bhel', time: '6:30', isSelected: false));
    appointList.add(Modal(name: 'Akash Bose', time: '4:30', isSelected: false));
    appointList
        .add(Modal(name: 'Priya shetty', time: '5:30', isSelected: false));
...
class Modal {
  ...
  Modal({this.name, this.isSelected = false, this.time});
}
